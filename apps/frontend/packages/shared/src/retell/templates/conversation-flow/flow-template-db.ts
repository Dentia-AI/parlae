...
export function flowTemplateToDbShape(
  ...
  const nodePrompts: Record<string, string> = {
    greeting: FLOW_GREETING_PROMPT,
    booking_collect: FLOW_BOOKING_COLLECT_PROMPT,
    booking_pick_slot: FLOW_BOOKING_PICK_SLOT_PROMPT,
    booking_contact: FLOW_BOOKING_CONTACT_PROMPT,
    booking_done: FLOW_BOOKING_DONE_PROMPT,
    booking_failed: FLOW_BOOKING_FAILED_PROMPT,
    post_action: FLOW_POST_ACTION_PROMPT,
    appt_mgmt: FLOW_APPT_MGMT_ENTRY_PROMPT,
    appt_cancel: FLOW_APPT_CANCEL_PROMPT,
    appt_resched: FLOW_APPT_RESCHED_PROMPT,
    appt_mgmt_done: FLOW_APPT_MGMT_DONE_PROMPT,
    appt_mgmt_failed: FLOW_APPT_MGMT_FAILED_PROMPT,
