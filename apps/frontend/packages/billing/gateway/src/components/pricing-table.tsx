...
export function PricingTable({
  ...
  return (
    <div className={'flex flex-col space-y-8 xl:space-y-12'}>
      ...
      <div
        className={
          'flex flex-col items-start space-y-6 lg:space-y-0 justify-center lg:flex-row lg:gap-x-4'
        }
      >
...
function PricingItem(
  ...
  return (
    <div
      ...
      className={cn(
        props.className,
        `w-full bg-card border border-border relative flex flex-1 grow flex-col items-stretch justify-between self-stretch rounded-xl px-6 py-5 shadow-lg transition-all hover:shadow-xl lg:w-4/12 xl:max-w-[20rem]`,
      )}
    >
      ...
      <div className={'flex flex-col gap-y-4'}>
        <div className={'flex flex-col'}>
          <div className={'flex items-center space-x-6'}>
            <b
              className={
                'text-foreground font-heading text-xl font-semibold tracking-tight'
              }
            >
              <Trans
