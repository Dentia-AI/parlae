...
export const createMockPrismaService = (): MockPrismaClient => {
  return {
    ...
    vapiPhoneNumber: prismaMock.vapiPhoneNumber,
    callReference: prismaMock.callReference,
    ghlSubAccount: prismaMock.ghlSubAccount,
    voiceAgent: prismaMock.voiceAgent,
    knowledgeBase: prismaMock.knowledgeBase,
    pmsIntegration: prismaMock.pmsIntegration,
    pmsWriteback: prismaMock.pmsWriteback,
    retellPhoneNumber: prismaMock.retellPhoneNumber,
    voiceProviderToggle: prismaMock.voiceProviderToggle,
    retellConversationFlowTemplate: prismaMock.retellConversationFlowTemplate,
    outboundSettings: prismaMock.outboundSettings,
    outboundCampaign: prismaMock.outboundCampaign,
    outboundAgentTemplate: prismaMock.outboundAgentTemplate,
    campaignContact: prismaMock.campaignContact,
