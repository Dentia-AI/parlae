...
ARG NEXT_PUBLIC_GHL_TRACKING_DOMAIN
ARG NEXT_PUBLIC_GHL_TRACKING_ID
# Analytics
...
ENV NEXT_PUBLIC_GHL_TRACKING_DOMAIN=$NEXT_PUBLIC_GHL_TRACKING_DOMAIN
ENV NEXT_PUBLIC_GHL_TRACKING_ID=$NEXT_PUBLIC_GHL_TRACKING_ID
# Analytics
